...
`0.1.3` 已证明源码、候选制品、GitHub 与 npm 分发身份；隔离 Runtime、真实 profile 和 consumer 仍未验证。既有 Runtime 与真实 Web consumer 结论只覆盖各自记录的 `0.1.0`/`0.1.1` 身份，不自动转移到新版本。
